...
\noindent Every result here is reproduced by the scripts in \texttt{scripts/} from the JSON artifacts in the repository root. Full methodology, covering validation design, ablations, seed replication, and the evidence behind every number, is in \texttt{TECHNICAL\_MEMO.md}.
...
\bibitem{scl} Wu, Z., et al. Beyond silent letters: Amplifying LLMs in emotion recognition with vocal nuances. \emph{arXiv:2407.21315}, 2024.
...
\bibitem{hvb} Wu, M., Nafziger, J., Scodary, A., and Maas, A. HarperValleyBank: A domain-specific spoken dialog corpus. \emph{arXiv:2010.13929}, 2020.
\end{thebibliography}
